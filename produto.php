  ...
  <body>
    ...
    <header class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
     ...
     <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
       ...
       <a class="me-3 py-2 text-dark text-decoration-none" href="home#contato">contato</a>
    ...
    <?php  //if(!isset($_SESSION['checkout']['iduser'])){
         ...
         <div class="row">
            <div class="col-md-12">
               <!--<a href="../control/produto.php?id=<?//=$produto->id;?>" class="btn btn-lg btn-success">LER</a>-->
