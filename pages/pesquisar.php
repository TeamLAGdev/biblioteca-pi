...
$busca = $_GET['pesquisa'];
$buscar_Produtos = $i->Produtos->buscar($busca); 
...
<html lang="pt-br">
  <head>
    ...
    <meta name="author" content="Leonardo Marcelo, André Lucas , Gabriel Gomes">
...
<link rel="shortcut icon" href="logo.ico" type="image/x-icon">
  ...
  <main>
        <div class="row mb-3 text-center" id="home">
          
        <h2 style="padding: 20px;">Você pesquisou: <?= $_GET['pesquisa']  ?></h2>
            ...
            if($buscar_Produtos){
                foreach ($buscar_Produtos as $produto) {
        ...
        <div class="col">  
            <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-header py-3" style="max-height: 80px; min-height: 80px;">
              ...
              <div class="card-body">
                ...
                <h5 class="card-title pricing-card-title"><small class="text-muted fw-light" style="font-size: 15px;"><?= $produto->autor?></small></h5>
    ...
    <div class="row">
      ...
      <div class="col-6 col-md">
        ...
        <ul class="list-unstyled text-small">
          ...
          <li class="mb-1"><a class="link-secondary text-decoration-none" target="_blank" href="https://m.facebook.com/etesurubim2" > <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
           <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
           </svg></a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none"  target="_blank" href="https://www.instagram.com/eteantonioarrudadefarias/?utm_medium=copy_link"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
      ...
      <div class="col-6 col-md">
        ...
        <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Privacy</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#"> Desenvolvedor: andre1234321a@gmail.com</a></li>
